    ...
    <main>
        ...
        <div class="relative py-16 px-4 sm:py-24 sm:px-6 lg:px-8 lg:max-w-7xl lg:mx-auto lg:py-32 lg:grid lg:grid-cols-2">
            ...
            <div class="max-w-md mx-auto sm:max-w-lg lg:mx-0">
                ...
                ¡Nos encantaría saber de ti! Envíenos un mensaje utilizando el formulario al lado o envíenos un correo electrónico.
                </p>
                ...
                <div class="sm:col-span-2">
                    <div class="flex justify-between">
                    <label for="how-can-we-help" class="block text-sm font-medium text-gray-700">Como te podemos ayudar?</label>
                    <span id="how-can-we-help-description" class="text-sm text-gray-500">Max. 500 caracteres</span>
                    </div>
                    <div class="mt-1">
