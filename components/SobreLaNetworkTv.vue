<template>
    ...
    <div class="relative max-w-7xl mx-auto pt-20 pb-12 px-4 sm:px-6 lg:px-8 lg:py-20">
        ...
        <div class="hidden lg:block lg:flex-shrink-0">
            <img class="h-64 w-64 object-contain rounded-full xl:h-80 xl:w-80" :src="img" alt="LaNetworkTv">
        </div>

        <div class="relative lg:ml-10">
            <svg class="absolute top-0 left-0 transform -translate-x-8 -translate-y-24 h-36 w-36 text-brand opacity-50" stroke="currentColor" fill="none" viewBox="0 0 144 144" aria-hidden="true">
            ...
            <div class="text-2xl leading-9 font-medium text-gray-900">
                <p>
                Es la división de <strong>LaNetwork</strong> dedicada a producciones audiovisuales. Luego de 4 años trabajando para 360films, comenzando como técnico y finalizando tercerizando producciones a nuestras manos hasta el 2009.
                </p><br />
                <p>
                Ahí me independizo como creador de cotenidos y comienzan las producciones en varias ramas del mundo audiovisual.
                </p>
            </div>
            <footer class="mt-8">
                <div class="flex">
                ...
                <div class="ml-4 lg:ml-0">
                    ...
                    <div class="text-base font-medium text-gray-900">LaNetworkTv</div>
                </div>
                </div>
            </footer>
            </blockquote>
...
export default {
    data() {
        return {
            img: require('../assets/ehbottom.png')
        }
    }
}
</script>